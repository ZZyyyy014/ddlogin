...
public class AesUtil {
    ...
    public static String loginDd(String loginName, String passwrod) throws Exception {
        String resurl="";
        CloseableHttpResponse execute1=null;
        CloseableHttpResponse execute=null;
        AesWebsocket aesWebsocket=null;
        try{
      ...
      //  aesWebsocket.close();
        ...
        httpPost.setEntity(new StringEntity(SSs));
          execute1 = client.execute(httpPost);
        // 获取实体内容
        ...
        Map jsonObject2 = (Map) JSONObject.parseObject(jsonObject12 + "");
         resurl = (String) jsonObject2.get("pluginOpenUrl");
       }catch (Exception e){
           e.printStackTrace();
       }finally {
            if (aesWebsocket!=null){
                aesWebsocket.close();
            }
           if (execute!=null){
               execute.close();
